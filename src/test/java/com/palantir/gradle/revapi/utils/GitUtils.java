...
package com.palantir.gradle.revapi.utils;
...
public final class GitUtils {
    ...
    public static void runCommands(File directory, String... commands) throws IOException, InterruptedException {
    ...
    public static void gitInit(File projectDir) throws IOException, InterruptedException {
        ...
        runCommands(projectDir, "config", "user.email", "test@example.com");
        runCommands(projectDir, "config", "user.name", "Test User");
    }
