...
abstract class RevapiConfig {
    ...
    public RevapiConfig withIgnoredBreaks(Set<AcceptedBreakV1> acceptedBreakV1s) {
        return withExtension("revapi.ignore", OBJECT_MAPPER.convertValue(acceptedBreakV1s, ArrayNode.class));
    }
